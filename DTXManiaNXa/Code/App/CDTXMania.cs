...
namespace DTXManiaNXa
{
    ...
    {
        // プロパティ
        public static readonly string VERSION_DISPLAY = "DTX:NXA:A:A:2025111200";
        public static readonly string VERSION = "v1.2.0 [NX 1.4.2 compatible]";
        ...
        public static Folder Folder { get; protected set; }
        public static CCharacterConsole actDisplayString { get; private set; }  // act文字コンソール
        ...
        public static string strSongDifficulyName { get; set; }
        ...
        public static CStageOption stageOption { get; private set; }
        ...
        public static string strEXEのあるフォルダ { get; private set; }
        ...
        {
            get => base.GraphicsDeviceManager.Direct3D9.Device;
        }
        ...
        private static Size currentClientSize { get; set; }		// #23510 2010.10.27 add yyagi to keep current window size
	...
	stage演奏ギター画面.fDamageLevelFactor[i] = ConfigIni.fDamageLevelFactor[i];
        ...
        private void tStartProcess()
        {
            ...
            if (ConfigIni.bOutputLogs)
            {
                try
                {
                    Trace.Listeners.Add( new CTraceLogListener( new StreamWriter( "DTXManiaLog.txt", false, new UTF8Encoding( false ) ) ) );
                }
            ...
            this.strWindowTitle = appName + " " + VERSION; // 今は x64 のみ対応。
