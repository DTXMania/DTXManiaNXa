...
//          this.nASIOBufferSizeMs = 0;                 // #24820 2012.12.25 yyagi 初期値は0(自動設定)
		...
		{
            StreamWriter sw = new StreamWriter( iniFilename, false, new UTF8Encoding( false ) );
			sw.WriteLine( ";-------------------" );
...
//			sw.WriteLine();																	//
		...
		public void tReadFromFile( string iniファイル名 )
		{
			...
			{
				string str;
				StreamReader reader = CStreamReaderWithEncodingDetection.Create( this.ConfigIniファイル名 );
