...
////				}
        ...
        public void tReadSkinConfig()
        {
            if( File.Exists( CSkin.Path( @"SkinConfig.ini" ) ) )
            {
                ...
                using( StreamReader reader = new StreamReader( CSkin.Path( @"SkinConfig.ini" ), new UTF8Encoding( false ) ) )
                {
        ...
        public void tSaveSkinConfig()
        {
            if( File.Exists( CSkin.Path( @"SkinConfig.ini" ) ) )
            {
                StreamWriter sw = new StreamWriter( CSkin.Path( @"SkinConfig.ini" ), false, new UTF8Encoding( false ) );
