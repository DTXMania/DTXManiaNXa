...
namespace DTXManiaNXa
{
    ...
    public interface IPluginActivity
	{
		...
		/// </summary>
		void On初期化( DTXManiaNXa.IPluginHost PluginHost );
		...
		/// </summary>
		void On進行描画( DTXManiaNXa.CPad pad, FDK.IInputDevice keyboard );
		...
		void On選択曲変更( string str選択曲ファイル名, DTXManiaNXa.CSetDef setDef, int nブロック番号inSetDef, int n曲番号inブロック );

		void On演奏クリア( DTXManiaNXa.CScoreIni scoreIni );
		void On演奏失敗( DTXManiaNXa.CScoreIni scoreIni );
		void On演奏キャンセル( DTXManiaNXa.CScoreIni scoreIni );
	}
}
