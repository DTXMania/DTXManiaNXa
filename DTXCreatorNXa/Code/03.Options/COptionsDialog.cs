...
namespace DTXCreatorNXa.Options  // オプション関連
{
	public partial class COptionsDialog : Form  // Cオプションダイアログ
	{
		...
		public void tレーンリストの内訳を生成する(List<DTXCreatorNXa.Score.CLane> listCLane)
		{
			DTXCreatorNXa.Score.CLane.ELaneType eLastLaneType = DTXCreatorNXa.Score.CLane.ELaneType.END;

			this.checkedListBoxLaneSelectList.BeginUpdate();
			foreach (DTXCreatorNXa.Score.CLane c in listCLane)
			{
