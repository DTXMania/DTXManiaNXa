...
using DTXCreatorNXa.チップパレット関連;
using DTXCreatorNXa.Score;
using DTXCreatorNXa.WAV_BMP_AVI;
using DTXCreatorNXa.UndoRedo;
using DTXCreatorNXa.Options;
using DTXCreatorNXa.汎用;
using DTXCreatorNXa.Properties;
using FDK;
...
namespace DTXCreatorNXa
{
	public partial class CMainForm : Form  // Cメインフォーム
	{
		...
		private void tアプリ設定の保存()
		{
			...
			foreach ( DTXCreatorNXa.Score.CLane c in this.mgr譜面管理者.listレーン )
			{
