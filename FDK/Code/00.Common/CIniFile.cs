...
namespace FDK
{
    ...
    public class CIniFile
    {
        ...
        public void tRead( string strファイル名 )
        {
            ...
            try
            {
                sr = CStreamReaderWithEncodingDetection.Create( this.strFilename ); // ファイルが存在しない場合は例外発生。
        ...
        public void tWrite()
        {
            ...
            try
            {
                sw = new StreamWriter( this.strFilename, false, new UTF8Encoding( false ) );    // オープン失敗の場合は例外発生。
