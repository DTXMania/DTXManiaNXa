namespace FDK
{
    public class CActivity
    {
        ...
        /// <para lang="ja">
        ///     Managed リソースの作成を行う。
        ///     Direct3D デバイスが作成された直後に呼び出されるので、自分が活性化している時に限り、Managed リソースを作成（または再構築）すること。
        ///     いつどのタイミングで呼び出されるか（いつDirect3Dが再作成されるか）分からないので、いつ何時呼び出されても問題無いようにコーディングしておくこと。
        ///     </para>
        /// <para lang="en">
        ///     Create Managed resources.
        ///     This method is called just after the Direct3D device is created, so create (or reconstruct) Managed resources only when you are activated.
        ///     Since you don't know when and at what timing it will be called (when Direct3D will be recreated), code it so that it can be called at any time without any problems.
        ///     </para>
        /// </summary>
