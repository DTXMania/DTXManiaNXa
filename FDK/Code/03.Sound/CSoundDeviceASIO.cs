...
namespace FDK
{
    ...
    public static class CEnumerateAllAsioDevices
    {
        public static string[] GetAllASIODevices()
        {
            ...
            var bassAsioDevInfo = BassAux.BASS_ASIO_GetDeviceInfos();
    ...
    public class CSoundDeviceASIO : ISoundDevice
    {
        ...
        public CSoundDeviceASIO( long n希望バッファサイズms, int _nASIODevice )
        {
            ...
            // hMixerの音量制御を反映させる。
            this.hMixer_DeviceOut = BassMix.CreateMixerStream( (int) this.db周波数, this.n出力チャンネル数, flag );
        ...
        protected void Dispose( bool bManagedDispose )
        {
            ...
            if( hMixer != 0 )
            {
                BassAux.BASS_Mixer_ChannelPause( this.hMixer );
